...
config.General.requestName = 'job_crab_mc_DsToPhiPi_ToMuMu_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_limibased'
#config.General.workArea = 'crab_data_Charmonium_finaljob_MINIAOD_CMSSW10218_18A_v1_Jhovanny'
config.General.workArea = 'crab_mc_DsToPhiPi_ToMuMu_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_lumibased'
